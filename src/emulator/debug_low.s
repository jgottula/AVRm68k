...
dbgDumpReg:
	...
	/* description: compares program memory for equality and returns a boolean
	 * parameters:
	 * - len  [r24]
	 * - src1 [r23:r22]
	 * - src2 [r21:r20]
	 * returns zero on equality, 0xff on inequality
	 * not public
	 */
	.type dbgProgMemCmp,@function
dbgProgMemCmp:
	savez
...
dbgProgMemCmp_Loop:
	...
	cp r20,r21
	brne dbgProgMemCmp_NotEqual
	
	dec r24
	brne dbgProgMemCmp_Loop
	
	/* r24 will conveniently be zero from the loop decrement */
	jmp dbgProgMemCmp_Equal
	
dbgProgMemCmp_NotEqual:
	ori r24,0xff
